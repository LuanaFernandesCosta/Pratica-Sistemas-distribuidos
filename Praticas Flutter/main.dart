  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        ...
        Cartao(
          titulo: 'Imagem 01',
          subtitulo: 'Lorem Ipsum is simply dummy text of the printing and typesettin ' +
              'g industry. Lorem Ipsum has been the industry\'s standard dummy text ever sinc ' +
        ...
        Cartao(
          ...
          subtitulo: 'Lorem Ipsum is simply dummy text of the printing and typesettin' +
              'g industry. Lorem Ipsum has been the industry\'s standard dummy text ever sinc' +
              'e the 1500s, when an unknown printer took a galley of type and scrambled it tomake a type specimen book. It has survived not only five centuries, but also' +
              'the leap into electronic typesetting, remaining essentially unchanged. It was' +
              'popularised in the 1960s with the release of Letraset sheets containing Lorem' +
              'Ipsum passages, and more recently with desktop publishing software like Aldus' +
              'PageMaker including versions of Lorem Ipsum.',
                ...
                TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Detalhe(ComprarDetalhes(
                                this.titulo,
                                this.subtitulo,
                                this.preco,
                                this.url))));
                ...
                TextButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Comprar(ComprarDetalhes(
                                  this.titulo,
                                  this.subtitulo,
                                  this.preco,
                                  this.url))));
